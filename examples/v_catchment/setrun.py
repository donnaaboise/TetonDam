...
#------------------------------
    ...
    clawdata.lower[1] = -800.0
    clawdata.upper[1] = 800.0
...
# Gauge 2 - Hydrograph of the outlet of one hillslope 50s resolution
    xc,yc = [750, 15]
    rundata.gaugedata.gauges.append([2,xc,yc,0.,clawdata.tfinal])  # gauge 2
...
#-------------------
    ...
    geo_data.dry_tolerance = 1.e-8    # For rainfall
    ...
    #    [topotype, fname]
    topo_data.topofiles.append([2, 'vcatch_dem.topo'])
